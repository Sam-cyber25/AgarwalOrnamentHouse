...
function initActiveNav() {
  ...
  /* Fix: keep only one current-page indicator active so Collections and Categories never show simultaneously. */
  const preferredLink = matchingLinks.find((link) => !link.closest(".has-dropdown")) || matchingLinks[0];
  if (preferredLink) {
